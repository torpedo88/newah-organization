...
/**
 * Liquid-glass and metal buttons.
 *
 * The source component also shipped a plain `Button`/`buttonVariants` pair.
 * They are left out here: `components/ui/button.tsx` already exports a Button,
 * and two of them under the same name invites importing the wrong one.
 */
...
/** Touch capability is static for the session, so there is nothing to subscribe to. */
...
const MetalButton = React.forwardRef<HTMLButtonElement, MetalButtonProps>(
  ({ children, className, variant = "default", ...props }, ref) => {
    ...
    // Read once from the client, never from the server, and without writing
    // state from an effect: touch capability does not change for a session.
...
export { liquidbuttonVariants, LiquidButton, MetalButton }
